...
<title>用户登录</title>
<link href="<s:url value="/customer/css/reg.css"/>" rel="stylesheet"
	type="text/css" />
<script src="<s:url value="/customer/js/jquery.js"/>"></script>
<script src="<s:url value="/customer/js/slider.js"/>"></script>
<script type="text/javascript" src="<s:url value="/js/common.js"/>"></script>
<script type="text/javascript"
	src="<s:url value="/js/vericode.js"/>"></script>
</head>
<body>
	<div class="wraper ">
		<div id="wrap">
			...
			<div id="main">
				<div class="area clearfix">
					<div class="title">
						<h3>立刻登陆</h3>
						我还没有账号<a href="<s:url value="/customer/reg.jsp"/>">立刻注册？</a>
					</div>
					<div class="login"> 
					<s:form name="loginform" action="/user/login"  id="form1">
					<input type="hidden" name="returnUrl" value="<%=request.getParameter("returnUrl")%>"/>
						<ul>
							...
							<span class="form1">
          					...
          					<a href="<s:url value="/customer/account/get_username.jsp"/>">找回用户名?</a>
							</li>
							<li><label>密&nbsp;&nbsp;码：</label>
							<span class="form1">
          					...
          					<a href="<s:url value="/customer/account/get_password.jsp" />">找回密码?</a>
							</li>
					...
					<div class="right">
						<a href="<s:url value="/customer/reg.jsp"/>" title="免费注册" class="zc">免费注册</a>
						<ol>
