...
<script type="text/javascript" src="<s:url value="/customer/js/reg.js"/>"></script>
...
<div class="title">
<h3>免费注册</h3>
我已经有账号<a href="<s:url value="/customer/login.jsp"/>">立刻登陆？</a></div>
<div class="login reg"><s:if test="result!=''&&result!=null">
	<div id="warning">${result}</div>
</s:if> <s:form method="post" action="register" id="regForm" namespace="/user">
	<h3>设置你的账户信息</h3>
	<ul>
