...
<html>
	<head> 
		...
		<link rel="stylesheet" href="/resource/member/css/date_input.css" type="text/css" />
		<script type="text/javascript" src="/resource/member/js/core/jquery.min.js"></script> 
		<script type="text/javascript" src="/resource/member/js/core/jquery.select_skin.js"></script> 
		<script type="text/javascript" src="/resource/member/js/core/jquery.filestyle.mini.js"></script> 
		<script type="text/javascript" src="/resource/member/js/core/ajaxfileupload.js"></script> 
		...
		<script type="text/javascript" src="/resource/member/js/core/validate.js"></script> 
