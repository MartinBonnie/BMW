			...
			<div id="main-content"> <!-- Main Content Section with everything --> 
				...
				<div class="block">
					...
					<div class="block_content">
						...
						<form action="/web/member/product/save" method="post">
						<div class="form">
							<p>
								<label>产品名称:</label><br />
								<input name="prodName" type="text" class="text small" style="font-size: 14px;padding: 5px;" /> 
								<span class="note">*</span>
							</p>
							<p>
								<label>产品型号:</label><br />
								<input name="prodModel" type="text" class="text small" style="font-size: 14px;padding: 5px;" /> 
							</p>
							<p>
								<label>产品品牌:</label><br />
							...
							<p>
								<label>系统分类:</label> <br /> <select class="styled"
									name="prodCategory">
									<c:forEach items="${prodCategory}" var="prodCategory">
												<option value="${prodCategory.sysId}">${prodCategory.sysName}</option>
									</c:forEach>
								</select>
							</p>
							<p>
							...
							<p>
								<label>价格:</label><br />
								<input name="prodPrice" type="text" class="text small" style="font-size: 14px;padding: 5px;"/> 
							</p>
							<p>
								<label>单位:</label><br />
								<input name="prodUnit" type="text" class="text small" style="font-size: 14px;padding: 5px;"/> 
							</p>
							<p>
								<label>关键字:</label><br />
								<input name="prodTag" type="text" class="text medium error" style="font-size: 14px;padding: 5px;"/> 
								<span class="note">多个关键字请用空格隔开</span>
							</p>
							<p>
								<label>产品简介:</label><br />
								<textarea id="prodDesc" name="prodDesc" class="wysiwyg"></textarea>
							</p>
							<p class="fileupload">
								<label>产品图片:</label><br />
