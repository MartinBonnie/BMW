		...
		<script type="text/javascript">
				...
				$("#submitFormBtn").click(function(){
					...
					if(categoryId==""){//add new category
						$.ajax({
				            type: "post",
				            dataType: 'json',
				            url: "/web/member/news/addCategory",
				            data: {
				            	"cdesc": cdesc,
				            	"belongId": belongId,
				            	"sort": isort,
						...
						$.ajax({
				            type: "post",
				            dataType: 'json',
							url: "/web/member/news/editCategory",
				            data: {
			...
			confirmDelCategory=function(categoryId){
				$.ajax({
		            type: "post",
		            dataType: 'json',
					url: "/web/member/news/delCategory",
		            data: {
		                "categoryId": categoryId,
		            },
		            success: function(result){
                                ...
                                <div class="content" >
                                    <div id="messages" > <!-- Messages are shown when a link with these attributes are clicked: href="#messages" rel="modal"  --> 
										<h3 id="formTitle">添加分类</h3> 
											...
											<div>
											<h4>上级分类</h4> 
											<select class="styled" id="belongId" name="belongId"> </select>
										<!-- 	<input id="belongId" name="belongId" type="text" value="" style="visibility: hidden;"/>   -->
											</div>
											<div>
											<h4>顺序</h4> 
