    ...
    <div id="wrap">
        ...
        <div id="container"  class="clearfix">
        	<div class="sideRight">
            	<div class="title">
                    <ul>
                        <li class="current"><a href="#"><span>公司介绍</span></a></li>
                        
                    </ul>
                </div>
                
                <div class="company">尊敬的客户：
	为更准确的展示企业的加工能力，方便买家查找，2010年6月24日，针对经营模式为"生产加工"类型的公司，系统将根据贵公司已发布的企业资料和信息情况，自动补充加工服务信息。请您及时查看和完善。如何设置公司的加工服务信息
        感谢您对阿里巴巴的理解和支持。</div>
