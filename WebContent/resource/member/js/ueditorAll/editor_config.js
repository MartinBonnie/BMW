...
URL= "/resource/member/js/ueditorAll/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
...
//,imageUrl:"http://localhost:8080/"           //图片上传提交地址
...
,filePath:"http://localhost"                   //附件修正地址，同imagePath
//,filePath:""
...
,imageManagerPath:"http://localhost/"                                   //图片修正地址，同imagePath
...
,toolbars:[["FullScreen","Source","Undo","Redo","InsertUnorderedList","InsertOrderedList","Unlink","Link","ClearDoc","SelectAll","SearchReplace","Preview","InsertImage","SnapScreen","Emotion","Attachment","Date","Time","Horizontal","Anchor","Spechars","BlockQuote","HighlightCode","background","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","Superscript","Subscript","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","touppercase","tolowercase","Indent","RemoveFormat","FormatMatch","PastePlain","CustomStyle","FontFamily","FontSize","ImageNone","ImageLeft","ImageRight","ImageCenter","InsertTable","DeleteTable","MergeRight","MergeDown","SplittoRows","SplittoCols","SplittoCells","MergeCells","InsertCol","InsertRow","DeleteCol","DeleteRow","InsertParagraphBeforeTable"],[]]
...
,'fontfamily':[{"label":"","name":"songti","val":"宋体,SimSun"},{"label":"","name":"timesNewRoman","val":"times new roman"},{"label":"","name":"kaiti","val":"楷体,楷体_GB2312, SimKai"},{"label":"","name":"heiti","val":"黑体, SimHei"},{"label":"","name":"lishu","val":"隶书, SimLi"},{"label":"","name":"andaleMono","val":"andale mono"},{"label":"","name":"arial","val":"arial, helvetica,sans-serif"},{"label":"","name":"arialBlack","val":"arial black,avant garde"},{"label":"","name":"comicSansMs","val":"comic sans ms"},{"label":"","name":"impact","val":"impact,chicago"}]
