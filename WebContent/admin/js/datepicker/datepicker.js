...
(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
			...
			showmonths: ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
            ...
            //the z-index value of the datepicker dom
            zIndex: 99999,
        ...
        plugin.show = function() {
            ...
            if (!plugin.settings.always_visible) {
                ...
                var
                    ...
                    left = offset.left,
                    top = offset.top+$element.outerHeight(true)+1,
        ...
        var generate_daypicker = function() {
            ...
            manage_header(plugin.settings.showmonths[selected_month] + ', ' + selected_year);
            ...
            for (var i = 0; i < 7; i++)
                ...
                html += '<th>' + plugin.settings.showdays[(plugin.settings.first_day_of_week + i) % 7] + '</th>';
            ...
            for (var i = 0; i < 42; i++) {
                ...
                if (i % 7 == 0 && plugin.settings.show_week_number) {
                    ...
                    // otherwise, this is the week's number
                    	...
                    	week_number = Math.floor((current_day_number + start_weekday - 1) / 7);
                    }
        ...
        var generate_monthpicker = function() {
            ...
            for (var i = 0; i < 12; i++) {
                ...
                html += '<td class="' + $.trim(class_name) + '">' + plugin.settings.showmonths[i] + '</td>';
    ...
    $.fn.Zebra_DatePicker_Remove = function(){
		 // if element has a date picker already attached
    	if (undefined != $(this).data('Zebra_DatePicker')) {
            ...
            $(document).unbind('keyup', plugin._keyup);
            $(document).unbind('mousedown', plugin._mousedown);
			$(this).removeData('data Zebra_DatePicker');
        }
    };
