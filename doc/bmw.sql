...
CREATE TABLE `bmw_account` (
  ...
  `owner_ip` varchar(32) DEFAULT NULL,
...
-- ----------------------------
-- Records of bmw_account
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_address`
-- ----------------------------
...
-- ----------------------------
-- Records of bmw_address
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_admanage`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_admanage`;
CREATE TABLE `bmw_admanage` (
  ...
  `ad_path` varchar(200) DEFAULT NULL,
  `ad_title` varchar(100) DEFAULT NULL,
  `ad_level` varchar(2) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `bmw_admin` VALUES ('1', 'jad', '5eac284f20692089267f44452e2f5f4d', null, null, null, null, null, null, null, null, null, null, null, null);
...
-- ----------------------------
-- Table structure for `bmw_bill`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_bill`;
CREATE TABLE `bmw_bill` (
  ...
  `recharge_id` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`bill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `bmw_category`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_category`;
CREATE TABLE `bmw_category` (
  ...
  `is_root` varchar(2) DEFAULT NULL,
...
-- ----------------------------
-- Records of bmw_category
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_comment`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_comment`;
CREATE TABLE `bmw_comment` (
...
-- ----------------------------
-- Records of bmw_comment
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_log`
-- ----------------------------
...
CREATE TABLE `bmw_log` (
  ...
  `log_class` varchar(2) DEFAULT NULL,
  `name` varchar(20) DEFAULT NULL,
  `desc` varchar(400) DEFAULT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `bmw_logistics`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_logistics`;
CREATE TABLE `bmw_logistics` (
  ...
  `order_id` varchar(32) DEFAULT NULL,
  `logistics_company` varchar(32) DEFAULT NULL,
  `ticket` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`logistics_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of bmw_logistics
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_mail_template`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_mail_template`;
CREATE TABLE `bmw_mail_template` (
...
-- ----------------------------
-- Records of bmw_mail_template
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_message`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_message`;
CREATE TABLE `bmw_message` (
...
-- ----------------------------
-- Records of bmw_message
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_module`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_module`;
CREATE TABLE `bmw_module` (
...
-- ----------------------------
-- Records of bmw_module
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_news`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_news`;
CREATE TABLE `bmw_news` (
...
CREATE TABLE `bmw_order` (
  ...
  `user_id` varchar(32) DEFAULT NULL,
  `score` int(11) DEFAULT NULL,
  `deal_state` varchar(2) DEFAULT NULL,
  `logistics_amounts` decimal(10,2) DEFAULT NULL,
  `desc` varchar(1000) DEFAULT NULL,
  `address` varchar(32) DEFAULT NULL,
  `product_id` varchar(32) DEFAULT NULL,
  `prod_count` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of bmw_order
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_product`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_product`;
CREATE TABLE `bmw_product` (
  ...
  `sell_count` smallint(6) DEFAULT NULL,
  `stock` smallint(6) DEFAULT NULL,
  `unit` varchar(20) DEFAULT NULL,
  `static_url` varchar(100) DEFAULT NULL,
  `desc` text,
  `com_times` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of bmw_product
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_recharge`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_recharge`;
CREATE TABLE `bmw_recharge` (
...
-- ----------------------------
-- Table structure for `bmw_timedj`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_timedj`;
CREATE TABLE `bmw_timedj` (
  `timedj_id` varchar(32) NOT NULL,
  `state` varchar(2) DEFAULT NULL,
  `add_time` datetime DEFAULT NULL,
  `start_hour` varchar(2) DEFAULT NULL,
  `start_minute` varchar(2) DEFAULT NULL,
  `end_hour` varchar(2) DEFAULT NULL,
  `end_minute` varchar(2) DEFAULT NULL,
  `name` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`timedj_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of bmw_timedj
-- ----------------------------

-- ----------------------------
-- Table structure for `bmw_transaction`
-- ----------------------------
DROP TABLE IF EXISTS `bmw_transaction`;
CREATE TABLE `bmw_transaction` (
...
CREATE TABLE `bmw_user` (
  ...
  `buyer_grade` varchar(32) DEFAULT NULL,
  `seller_grade` varchar(32) DEFAULT NULL,
  `buyer_grade_score` int(11) DEFAULT NULL,
  `seller_grade_score` int(11) DEFAULT NULL,
  `edit_time` datetime DEFAULT NULL,
  `edit_ip` varchar(20) DEFAULT NULL,
  `last_time` datetime DEFAULT NULL,
  `last_ip` varchar(20) DEFAULT NULL,
